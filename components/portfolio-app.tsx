      ...
      <div className="mb-7 min-w-0 grid gap-4 xl:grid-cols-[minmax(0,1.55fr)_minmax(320px,.85fr)]">
        <section className="overflow-hidden rounded-3xl bg-[#152b4a] p-6 text-white shadow-[0_18px_55px_rgba(21,43,74,.16)] md:p-8">
          ...
          <div className="mt-8 h-44 min-w-0 w-full">
            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={1} initialDimension={{ width: 1, height: 176 }}>
      ...
      {loadError ? (
        ...
        <>
          ...
          <p className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm leading-6 text-slate-600">
            Northstar starts tracking an account on the earliest valid activity date in its imported Robinhood history. Cash, holdings, and cost basis are derived from those imported transactions.
          </p>
        </>
      )}
